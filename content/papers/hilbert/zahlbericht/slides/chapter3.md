...
<div id="pdf-viewer" style="text-align: center;">
  ...
  <div style="margin-top: 10px;">
    <a href="/slides/hilbert/zahlbericht/chapter3.pdf" target="_blank" style="font-size: 14px;">📥 PDFをダウンロード</a>
  </div>
</div>

<script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js"></script>
<script>
  const url = '/slides/hilbert/zahlbericht/chapter3.pdf';
  let pdfDoc = null;
  let pageNum = 1;
